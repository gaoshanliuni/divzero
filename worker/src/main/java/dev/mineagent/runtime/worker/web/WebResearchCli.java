...
public final class WebResearchCli {
    public static void main(String[] args)throws Exception{
        ...
        try{
            ...
            var service=new WebResearchService();Object result=switch(args[0]){case "search"->service.search(args[1]);case "web"->service.search(args[1],"web");case "read"->service.read(args[1]);default->throw new IllegalArgumentException("WEB_ACTION");};
