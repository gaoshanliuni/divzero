...
public final class ModelGeometryTools {
    ...
    public static Map<String,Object> capabilities(){return Map.of(
        ...
        "collision","AABB only. Smooth render surfaces and torus holes do not imply spherical/hollow collision.");}
