...
public final class WebSettingsCatalog {
    ...
    public static final List<Field> FIELDS=List.of(
        ...
        new Field("provider.openai.model","模型名称","Provider","text","",PermissionAction.MANAGE_PROVIDERS),
        ...
        new Field("provider.ollama.model","Ollama 模型","Ollama","text","",PermissionAction.MANAGE_PROVIDERS),
        ...
        new Field("runtime.maxAgents","新建 AI 数量上限（1–4）","运行资源","number","4",PermissionAction.MANAGE_PERMISSIONS),
