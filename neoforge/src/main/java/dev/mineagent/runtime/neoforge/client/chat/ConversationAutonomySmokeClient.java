...
final class ConversationAutonomySmokeClient {
    ...
    }catch(Exception e){done=true;AutonomousBodyClient.stop("SMOKE_END");Files.writeString(root().resolve("client-failure.json"),new com.google.gson.Gson().toJson(Map.of("error",e.toString(),"observed",AutonomousBodyClient.observe())));dev.mineagent.runtime.neoforge.client.cinematic.CinematicCaptureClient.finish();}}
}
