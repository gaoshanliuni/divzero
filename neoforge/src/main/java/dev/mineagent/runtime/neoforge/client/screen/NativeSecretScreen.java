...
public final class NativeSecretScreen extends Screen {
    ...
    @Override protected void init(){
        ...
        save=addRenderableWidget(Button.builder(Component.literal("保存"),b->submit(input.getValue())).bounds(left,175,w/2-4,23).build());
