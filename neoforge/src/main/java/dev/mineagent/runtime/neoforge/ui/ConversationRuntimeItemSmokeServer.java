...
public final class ConversationRuntimeItemSmokeServer {
    ...
    public static boolean basketball(){return System.getProperty("mineagent.conversationAgentScenario","").startsWith("basketball");}
    public static boolean throwing(){return System.getProperty("mineagent.conversationAgentScenario","").startsWith("runtime_throw");}
    public static boolean saved(){return Set.of("runtime_item_saved","runtime_throw_saved","runtime_throw_sphere_saved","basketball_saved").contains(System.getProperty("mineagent.conversationAgentScenario",""));}
    public static boolean active(){return Boolean.getBoolean("mineagent.conversationAgentReal")&&(basketball()||throwing()||saved()||System.getProperty("mineagent.conversationAgentScenario","").equals("runtime_item"));}
    ...
    public static void tick(MinecraftServer s){
        ...
        try{
            ...
            if(phase==5){ConversationBasketballSmokeServer.tick(s,p);return;}
