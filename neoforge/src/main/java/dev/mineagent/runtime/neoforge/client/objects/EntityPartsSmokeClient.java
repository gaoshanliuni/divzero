...
public final class EntityPartsSmokeClient {
    ...
    @SubscribeEvent public static void tick(ClientTickEvent.Post event){if(!EntityPartsSmokeServer.enabled())return;var mc=Minecraft.getInstance();if(mc.level==null)return;if(mc.screen!=null)mc.setScreen(null);
