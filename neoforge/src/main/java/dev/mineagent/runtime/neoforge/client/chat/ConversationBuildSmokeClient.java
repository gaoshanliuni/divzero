...
final class ConversationBuildSmokeClient {
    ...
    static void tick()throws Exception{
        ...
        try{
            ...
            if(ConversationBuildSmokeServer.saved())sent=true;
            ...
            if(ConversationBuildSmokeServer.verified){
                ...
                if(receipts.isEmpty()&&!ConversationBuildSmokeServer.saved())throw new IllegalStateException("BUILD_NO_REAL_PROVIDER_RECEIPTS");
